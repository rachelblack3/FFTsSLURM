...
class DataFiles:
    ...
    def survey_data(self):
        ...
        # root folder
        survey_folder ='/data/hpcdata/users/rablack75/first_attempt/data'
        # 'stem' name for burst CDFs
        survey_file= 'rbsp-a_WFR-spectral-matrix-diagonal_emfisis-L2_'

        survey_path = os.path.join(survey_folder, day,survey_file + date_string + "_v*.cdf")
    ...
    def magnetic_data(self):
        ...
        # root folder
        l3_folder ='/data/hpcdata/users/rablack75/first_attempt/data/magnetometer'

        # 'stem' name for burst CDFs
        l3_file= 'rbsp-a_magnetometer_1sec-geo_emfisis-L3_'

        l3_path = os.path.join(l3_folder,l3_file + date_string + "_v*.cdf")
    ...
    def burst_paths(self):
        ...
        # root folder
        wfr_folder ='/data/hpcdata/users/rablack75/first_attempt/data'
        ...
        # Full filepath
        wfr_burst_path = os.path.join(wfr_folder,day, burst6 + date_string + "*_v*.cdf")
